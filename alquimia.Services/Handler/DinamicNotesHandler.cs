...
namespace alquimia.Services.Handler
{
    public class DinamicNotesHandler : IChatDynamicNodeHandler
    {
        ...
        {
            var msg = "Una nota es uno de los aromas individuales que se combinan para crear un perfume. Son los distintos olores que vas percibiendo desde que lo aplicás hasta que pasa el tiempo. Las notas se clasifican en notas de fondo, notas de corazón y notas de salida";
